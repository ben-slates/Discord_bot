...
class AdminCog(commands.Cog):
    ...
    @app_commands.describe(channel="The channel to send the message to", content="The message to send")
    async def message(self, interaction: discord.Interaction, channel: discord.TextChannel, content: str = None):
        ...
        class MessageModal(discord.ui.Modal, title="Send Message"):
            def __init__(self, target_channel: discord.TextChannel, prefill: str | None = None):
                super().__init__()
